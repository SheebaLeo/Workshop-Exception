...
public class CSVReader_Writer {
    ...
    public static List<String> getMaleFirstNames(){
        ...
        try {
            ...
            names = reader.lines()
                ...
                System.err.println("File not found: " + "firstname_males.txt");
                e.printStackTrace();
            } catch (IOException e) {
                System.err.println("Error reading from file: " + "firstname_males.txt");
                e.printStackTrace();
            } finally {
                if (reader != null) {
                    try {
    ...
    public static List<String> getFemaleFirstNames(){
        ...
        List<String> names=null;
            ...
            try {
                ...
                System.err.println("Error reading from file: firstname_female.txt");
                e.printStackTrace();
        }
    ...
    public static List<String> getLastNames() throws IOException{
        ...
        try{
            ...
            System.err.println("An error occurred while fetching last names.");
            e.printStackTrace();
        } finally {
            if(reader != null){
                reader.close();
    ...
    public static void saveLastNames(List <String> lastNames) {
        ...
        try {
            ...
            System.err.println("An error occurred while saving the last names.");
            e.printStackTrace();
        } finally {
            if (writer != null) {
                try {
    ...
    public static void saveFemaleNames(List <String> femaleNames) {
        ...
        try {
            ...
            System.err.println("An error occurred while saving the female last names.");
            e.printStackTrace();
        } finally {
            if (writer != null) {
                try {
    ...
    public static void saveMaleNames(List <String> maleNames) {
        ...
        try {
            ...
            System.err.println("An error occurred while saving the male last names.");
            e.printStackTrace();
        } finally {
            if (writer != null) {
                try {
                    ...
                    System.err.println("Error closing BufferWriter");
                    e.printStackTrace();
                }
            }
        }
